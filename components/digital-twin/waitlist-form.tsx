...
export default function WaitlistForm() {
  ...
  if (status === "done") {
    return (
      ...
      >
        <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-emerald-400">
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
      ...
      <input
        ...
        className="flex-1 min-h-[44px] rounded-xl border border-white/15 bg-white/5 px-4 py-2.5 text-sm text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-emerald-300"
      />
      ...
      <motion.button
        ...
        className="min-h-[44px] shrink-0 cursor-pointer rounded-xl bg-emerald-400 px-6 py-2.5 text-sm font-semibold text-emerald-950 shadow-sm disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-offset-2"
      >
