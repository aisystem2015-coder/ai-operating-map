    ...
    <div ref={sectionRef} className="space-y-16">
      ...
      <SectionReveal>
        <div
          ...
          style={{ background: "linear-gradient(160deg, #022c22 0%, #064e3b 55%, #0a1838 100%)" }}
        >
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            {ready && isReturning && (
              <motion.p
                ...
                className="inline-flex items-center gap-2 rounded-full bg-white/10 border border-white/15 px-3.5 py-1.5 text-xs text-blue-200"
              >
