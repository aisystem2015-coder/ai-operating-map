...
export default function DigitalTwinTeaser() {
  return (
    ...
    >
      <div className="mx-auto h-12 w-12 rounded-2xl bg-blue-900 flex items-center justify-center">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
        <Link
          ...
          className="min-h-[44px] cursor-pointer inline-flex items-center gap-2 rounded-xl bg-blue-900 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:brightness-110 transition focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2"
        >
